...
# A9G port of DFRobot_ENS160 raspberry python library
# for ENS160 multigas sensor via i2c
...
class DFRobot_ENS160_I2C(DFRobot_ENS160):
    ...
    def __init__(self, i2c):
        '''!
          ...
          @param i2c I2C A9G initialized object 
          @param _addr I2C bus
        '''
        self._addr = 0x53
        self.i2c = i2c
    ...
    def _write_reg(self, reg, data):
        ...
        self.i2c.mem_transmit(2, self._addr, reg, 1, data, 10)
    ...
    def _read_reg(self, reg, length):
        ...
        return self.i2c.mem_receive(2, self._addr, reg, 1, length, 10)
